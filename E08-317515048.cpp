...
void CrearDado8()
{
	...
	GLfloat octa_vertices[] = {
		...
		-0.5f, 0.0f,  -0.5f,	0.75f,  0.02f,		0.0f,	0.0f,	1.0f,
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//*************************** Instancia Lampara ***************************************//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(5.0f, 2.5f, -3.0));
