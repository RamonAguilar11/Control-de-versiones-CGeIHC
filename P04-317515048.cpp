...
Sphere sp = Sphere(0.5, 20, 20); //recibe radio, slices, stacks; Cambiar radio a 0.1 para la grúa :D
...
int main()
{
	...
	*/
	...
	glm::mat4 modelaux2(1.0); //Matriz auxiliar 2
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0f, 3.0f, 3.5f)); //No se debe heredar 
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotación
		...
		model = glm::translate(model, glm::vec3(2.5f, -1.0f, 1.75f)); // Traslación relativa a la base
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotación
		modelaux2 = model; // Guardar el estado de la articulación 2 (usando modelaux2)
		model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f)); // Escala
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Llanta 2 (cilindro)
		model = modelaux2; // Heredar de la articulación 2
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.5f)); // Traslación relativa a la articulación
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // Rotación adicional 
		model = glm::scale(model, glm::vec3(2.0f, 1.0f, 2.0f)); // Escala
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Reiniciar model a la matriz base antes de la articulación 3
		model = modelaux;

		// Articulación llanta 3
		model = glm::translate(model, glm::vec3(-2.5f, -1.0f, -1.75f)); // Traslación relativa a la base
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotación
		modelaux2 = model; // Guardar el estado de la articulación 3 (usando modelaux2)
		model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f)); // Escala
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Llanta 3 (cilindro)
		model = modelaux2; // Heredar de la articulación 3
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.5f)); // Traslación relativa a la articulación
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // Rotación adicional 
		model = glm::scale(model, glm::vec3(2.0f, 1.0f, 2.0f)); // Escala
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Reiniciar model a la matriz base antes de la articulación 4
		model = modelaux;

		// Articulación llanta 4
		model = glm::translate(model, glm::vec3(2.5f, -1.0f, -1.75f)); // Traslación relativa a la base
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8()), glm::vec3(0.0f, 0.0f, 1.0f)); // Rotación
		modelaux2 = model; // Guardar el estado de la articulación 4 (usando modelaux2)
		model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f)); // Escala
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); // Cambiar el color del objeto
		...
		// Llanta 4 (cilindro)
		model = modelaux2; // Heredar de la articulación 4
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.5f)); // Traslación relativa a la articulación
		...
		model = glm::translate(model, glm::vec3(0.0f, 6.0f, -4.0f)); //Origen en el plano de piso, por eso se traslada en Y 6 unidades (H.base+H.Cabina+H.Llantas)
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model; //Matrix auxiliar
		model = glm::scale(model, glm::vec3(3.5f, 3.5f, 3.5f)); //No se debe heredar
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux; //Ya no se hereda la escala de la esfera al brazo

		//Brazo 1
		model = glm::rotate(model, glm::radians(135.0f), glm::vec3(0.0f, 0.0f, 1.0f)); //Brazo inclinado 135° en Z (No se mueve), X y Y se mueven 135° (X->Arriba Izquierda, Y->Abajo Izquierda)
		...
		//Brazo 3
		model = glm::translate(model, glm::vec3(2.5f, 0.0, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		...
		//Articulacion 4
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion4()), glm::vec3(0.0f, 1.0f, 0.0f)); //La canasta gira en Y
		modelaux = model;
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos 
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(0.0f, 0.0, -0.8f));
		modelaux = model;
		...
		*/
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render(); //Para dibujar la esfera
		//Segunda parte de la Pata izquierda trasera
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f)); // Traslación relativa a la articulación
		model = glm::scale(model, glm::vec3(0.8f, 2.5f, 0.8f)); // Escala
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render(); //Para dibujar la esfera
		//Segunda parte de la Pata derecha delantera
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f)); // Traslación relativa a la articulación
		model = glm::scale(model, glm::vec3(0.8f, 2.5f, 0.8f)); // Escala
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Ojo izquierdo
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.9f, 1.0f, 0.7f));
		modelaux = model; 
